import logo from "../componentResources/images/icons/logo-sm.png";
import search from "../componentResources/images/icons/search-icon-sm.png";
import cart from "../componentResources/images/icons/cart-sm.png";
